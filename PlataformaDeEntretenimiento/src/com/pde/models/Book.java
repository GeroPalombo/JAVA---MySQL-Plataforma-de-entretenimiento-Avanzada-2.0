...
public class Book extends Publication implements IVisualizable {
	...
	public void view() {
		...
		do {
			...
			if (i != 0) {
				System.out.println("1. Volver a la pagina de atras");
			}
			...
			int response  = PdeUtil.validateUserResponseMenu(0, 2);
	...
	public static ArrayList<Book> makeBookList() {
		...
		for (int i = 0; i < 3; i++) {
			pagina = i+1;
			pages.add(new Book.Page(pagina, "Estas en la pagina " + pagina));
		}
